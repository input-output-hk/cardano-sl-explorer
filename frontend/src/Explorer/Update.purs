...
update RequestGenesisAddressInfoTotalPages state =
    { state:
          ...
          state
    , effects: [ attempt (fetchGenesisAddressInfoTotalPages pagination (PageSize maxAddressInfoRows))
